...
export function DiagnosePage() {
  ...
  return <div className="page"><PageTitle title="Diagnose" /><div className="page-head"><span className="eyebrow">Diagnose</span><h1>AutoVinFix Smart Diagnosis</h1><p>Pick a tool below. Vehicle-aware results appear when a vehicle is selected.</p></div><SelectedVehicleCard vehicle={selectedVehicle} />
