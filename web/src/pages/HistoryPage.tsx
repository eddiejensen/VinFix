...
import { CLOUD_DATA_RESTORE_EVENT, makeId, readLocalArray, type RepairEntry, STORAGE_KEYS, vehicleKey, writeLocalArray } from "../utils/localData";
...
export function HistoryPage() {
  ...
  useEffect(() => {
    const reload = () => setEntries(readLocalArray(STORAGE_KEYS.repairHistory));
